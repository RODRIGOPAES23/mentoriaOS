  ...
  return (
    ...
    >
      ...
      <div className={`relative flex items-center h-[65px] ${collapsed ? "justify-center px-0" : "px-5 gap-2.5"}`} style={{ borderBottom: `1px solid ${C.border}` }}>
        <div className="w-9 h-9 rounded-xl flex items-center justify-center shrink-0" style={{ background: `${C.green}20`, border: `1px solid ${C.green}44` }}>
        ...
        {!collapsed && (
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[9px] mt-0.5 tracking-widest" style={{ color: C.muted }}>MENTORIA INTELIGENTE</p>
          </div>
        )}
        <button
          onClick={onToggle}
        ...
        {ITENS.map(({ id, label, icon: Icon }) => {
          ...
          return (
            <button
              ...
              style={isActive
                ? { background: C.green, color: "#0a1628" }
                : { color: C.muted }}
