  ...
  return (
    <div style={{ background: SC.bg, color: "#fff" }} className="min-h-screen">
      ...
      <section className="max-w-5xl mx-auto px-5 pb-12 grid grid-cols-2 md:grid-cols-4 gap-5">
        ...
        <a href={`mailto:${EMAIL}?subject=Quero%20agendar%20uma%20demonstra%C3%A7%C3%A3o`} className="rounded-2xl p-7 text-center transition-all hover:-translate-y-1" style={{ background: SC.card, border: `1px solid ${SC.gold}44` }}>
          <div className="w-12 h-12 rounded-xl flex items-center justify-center mx-auto mb-3" style={{ background: `${SC.teal}18`, border: `1px solid ${SC.teal}33` }}><Calendar className="w-6 h-6" style={{ color: SC.teal }} /></div>
      ...
      <section className="max-w-3xl mx-auto px-5 pb-20 text-center">
        <div className="rounded-2xl p-8" style={{ background: SC.card, border: `1px solid ${SC.gold}33` }}>
